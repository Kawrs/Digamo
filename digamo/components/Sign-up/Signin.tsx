...
const signin = () => {
  return (
    <div className="hidden md:block w-full md:w-4/7 bg-gradient-to-tl from-[#F0B60E] to-[50%] to-[#B8D4C8] rounded-l-2xl z-0 relative">
      <div className="flex flex-col items-center justify-center h-full w-full">
        <div className=" m-10 items-center justify-center flex flex-col">
          ...
          <Link href="/auth/login">
            <button
              className=" text-white rounded-2xl h-8 w-50 mt-5 
