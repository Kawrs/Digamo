...
const FavoriteModal = () => {
  return (
    <div className="flex flex-col justify-center p-10 gap-5 mt-15 w-full max-w-5xl mx-auto">
        <section>
            <div className=" bg-gradient-to-r from-[#F7931E]/50 to-white/0 z-0 w-3/4 rounded-2xl w-full">
        ...
        <section>
            <div className="border-1 border-[#F7931E] p-5 rounded-2xl">
                <h1 className="font-monsterrat font-bold text-4xl">Ingredients</h1>
                <h2 className="font-light text-[#595959] text-sm">For 5 Serving</h2>
                <ul className="list-disc marker:text-[#F7931E] text-md mt-5 gap-2 ml-8">
                    <li>Ingredient 1</li>
                    <li>Ingredient 2</li>
                </ul>
            </div>
        ...
        <section>
            <div className="border-1 border-[#F7931E] p-5 rounded-2xl">
                <h1 className="font-monsterrat font-bold text-4xl">Steps</h1>
