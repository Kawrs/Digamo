        ...
        <div className=' h-full w-2/5 bg-gradient-to-tl from-[#F0B60E] to-[#B8D4C8] rounded-l-2xl z-0 relative -mr-5'>
          <div className='flex flex-col items-center justify-center h-full w-full'>
            <div>
              ...
              <button className='bg-[#EF4444] border-2 border-[#EF4444] text-white rounded-2xl h-8 w-50 mt-5 
        ...
        <div className=' h-full w-1/2 rounded-2xl z-10 relative bg-white' >
          <div className='flex flex-col items-center h-full w-full mt-7 '>
            ...
            <div className='flex flex-col gap-4 relative left-15'>
              ...
              <button className='bg-[#4F4F4F] text-white rounded-2xl relative left-15 h-8 w-90 hover:cursor-pointer hover:bg-[#EF4444]
                      active:translate-y-1 transition-ease-out duration-100'>Sign Up</button>
          </div>
